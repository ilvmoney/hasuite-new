...
namespace HaCreator.MapEditor
{
    public class WzFileManager
    {
        ...
        /// Gets the wz path
        /// </summary>
        /// <returns>Returns the wz path</returns>
        ...
        /// <summary>
        /// Loads a wz file by name
        /// </summary>
        /// <param name="name">Name of the wz file</param>
        /// <returns>True if successful in loading the wz file, false if unsuccessful</returns>
